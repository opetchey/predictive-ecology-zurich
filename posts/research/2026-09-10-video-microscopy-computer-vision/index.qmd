...
Here's a short video of a microbial community under the microscope — dozens of individual organisms swimming, dividing, interacting.
...
Try counting them. Try telling the species apart. Try judging which ones are moving fastest, or whether any of them are changing size over time. It's hard even for a few seconds of footage — and these experiments typically run for hundreds of generations, across many replicate communities. That's the measurement problem this post is about.

*(Psst — spoiler alert: there's a second version of this same kind of footage at the bottom of the post, with every individual organism automatically tracked. Keep reading.)*
...
As promised — here's that same kind of footage again, but this time run through BEMOVI's tracking pipeline, with every individual organism identified and followed frame by frame to reconstruct its movement trajectory:

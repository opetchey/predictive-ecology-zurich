...
The scale of the empirical effort was formidable: approximately 50,000 directly observed feeding interactions across 14 naturally heated streams. The warmer food webs were simpler, with shorter pathways transferring energy from resources through consumers. Yet a relatively simple allometric diet-breadth framework predicted approximately 68–82% of the observed feeding interactions, as well as important effects of warming on food-web properties (O’Gorman et al., 2019). The same geothermally heated Icelandic streams also feature in the group's wider work on [natural ecosystems](../2026-09-17-from-streams-to-forests/index.qmd), where the focus shifts from food-web architecture to the ciliate communities living in the streams themselves.
